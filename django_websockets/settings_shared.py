...
NOSE_ARGS = [
    '--with-coverage',
    '--cover-package=django_websockets',
]
...
TEMPLATE_DIRS = (
    "/var/www/django_websockets/templates/",
...
STATSD_PREFIX = 'django_websockets'
STATSD_HOST = '127.0.0.1'
STATSD_PORT = 8125

THUMBNAIL_SUBDIR = "thumbs"
EMAIL_SUBJECT_PREFIX = "[django_websockets] "
EMAIL_HOST = 'localhost'
SERVER_EMAIL = "django_websockets@ccnmtl.columbia.edu"
